        ...
        >
          <div slot="content">
            <div class="title-item">
              <span class="front">{{ $t('statusBar.wordsLabel') }}</span><span class="text">{{wordCount['word']}}</span>
            </div>
            <div class="title-item">
              <span class="front">{{ $t('statusBar.charactersLabel') }}</span><span class="text">{{wordCount['character']}}</span>
            </div>
            <div class="title-item">
              <span class="front">{{ $t('statusBar.paragraphsLabel') }}</span><span class="text">{{wordCount['paragraph']}}</span>
            </div>
          </div>
          <div
            v-if="wordCount"
